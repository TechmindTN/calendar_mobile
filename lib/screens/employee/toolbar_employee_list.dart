...
class EmployeeListToolbar extends StatefulWidget {
  final EmployeesController empController;

  const EmployeeListToolbar({super.key, required this.empController});
  @override
  State<EmployeeListToolbar> createState() =>
      // ignore: no_logic_in_create_state
      _EmployeeListToolbar(empController);
}

class _EmployeeListToolbar extends State<EmployeeListToolbar> {
      ...
      children: [
        Text('First name  ',
            style: GoogleFonts.ubuntu(
                textStyle: TextStyle(color: Colors.white, fontSize: 2.h))),
        Icon(
  ...
  final List<String> idList = ["1", "2", "3", "4", "5"];
  String? stringValue;
  Widget? value;

  _EmployeeListToolbar(this.empController);
    ...
    return Row(
      ...
      children: [
        Row(
          children: [
            Container(
              padding: EdgeInsets.only(left: 2.5.w, top: 2.h),
              height: 7.h,
              width: 23.5.w,
              child: TextField(
